...
function delete_jquery_wp() {
    // suppression jquery de wordpress
    wp_deregister_script( 'jquery' );
}
add_action ( 'wp_enqueue_scripts', 'delete_jquery_wp' );
...
function labasc_scripts() {
    ...
    wp_register_script( 'fontawesome', 'https://kit.fontawesome.com/b170d57b75.js','', LABASC_VERSION , true );
    wp_enqueue_script( 'fontawesome' );
    
}
add_action('wp_enqueue_scripts', 'labasc_scripts');

// chargement de scripts dans le footer
function labasc_scripts_footer() {
    // suppression jquery de wordpress
    wp_deregister_script( 'jquery' );
    
    // chargement des scripts
    wp_register_script('labasc_jquery-js', get_template_directory_uri() . '/assets/js/jquery.min.js', array(), LABASC_VERSION ,true );
    wp_enqueue_script( 'labasc_jquery-js' );
    wp_enqueue_script( 'labasc_bootstrap-js', get_template_directory_uri() . '/assets/js/bootstrap.min.js', array('labasc_jquery-js'), LABASC_VERSION , true );
    wp_enqueue_script( 'labasc_index_script', get_template_directory_uri() . '/assets/js/index.js', array('labasc_jquery-js', 'labasc_bootstrap-js'), LABASC_VERSION , false );
}
add_action('wp_footer', 'labasc_scripts_footer');
...
//     add_theme_support('title-tag');
    ...
    register_nav_menus(
        array(
            'primaire' => __('menu primaire', 'theme_bascule')
        )
    );
