...
<div class="container my-5">
    <div class="row">
        ...
        <div class="col-3">
            <img class="img-faq" src="<?php echo get_template_directory_uri(); ?>/img/faq/FAQ.jpg" alt="FAQ"/>
        </div>
                        ...
                        <div class="modal-body">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="text-faq">
                                            <h1 class="heading text-center bf pt-4 pb-3">La <span class="text-uppercase">BASCULE,</span> <span class="bc">c'est quoi ?</span></h1>
                        ...
                        <div class="modal-body">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="text-faq">
                                            <h1 class="heading text-center bf pt-4 pb-3">La <span class="text-uppercase">BASCULE,</span> <span class="bc">c'est qui ?</span></h1>
                        ...
                        <div class="modal-body">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <h1 class="heading text-center bf pt-4 pb-3">La <span class="text-uppercase">BASCULE,</span> <span class="bc">pourquoi ?</span></h1>
                        ...
                        <div class="modal-body">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <h1 class="heading text-center bf pt-4 pb-3">La <span class="text-uppercase">BASCULE,</span> <span class="bc">pour quoi ?</span></h1>
                        ...
                        <div class="modal-body">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <h1 class="heading text-center bf pt-4 pb-3">La <span class="text-uppercase">BASCULE,</span> <span class="bc">comment faites-vous ?</span></h1>
                        ...
                        <div class="modal-body">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <h1 class="heading text-center bf pt-4 pb-3">La <span class="text-uppercase">BASCULE,</span> <span class="bc">oui mais concrètement ?</span></h1>
                                        <ul class="list-style-custom">
                                            ...
                                            <li><i class="arrow-right-home fas fa-arrow-right bf mr-2"></i><span class="bf-under">Lobbying Citoyen:</span> pour donner les moyens aux citoyens de comprendre, débattre et agir.</li>
                        ...
                        <div class="modal-body">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <h1 class="heading text-center bf pt-4 pb-3">La <span class="text-uppercase">BASCULE,</span> <span class="bc">avec quels moyens ?</span></h1>
                                        <span class="bf-under">Tout cela est rendu possible grâce:</span>
                                        <ul class="list-style-custom">
                                            <li><i class="arrow-right-home fas fa-arrow-right bf mr-2"></i> au travail bénévole d’une cinquantaine de volontaires à temps plein.</li>
                                            <li><i class="arrow-right-home fas fa-arrow-right bf mr-2"></i> à l’allocation d’une partie des fonds levés pour mener les projets.</li>
                        ...
                        <div class="modal-body">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <h1 class="heading text-center bf pt-4 pb-3">La <span class="text-uppercase">BASCULE,</span> <span class="bc">depuis quand ?</span></h1>
                        ...
                        <div class="modal-body">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <h1 class="heading text-center bf pt-4 pb-3">La <span class="text-uppercase">BASCULE,</span> <span class="bc">ça se passe ou ?</span></h1>
...
<div class="container my-5">
    ...
    <div class="tab-content" id="nav-tabContent">
        ...
        <div class="tab-pane fane" id="nav-rejoins" role="tabpanel" aria-labelledby="nav-rejoins-tab">
                <div class="row row-home-moi position-relative row-tab-rejoindre text-center">
                    <div class="tab-rejoindre">
                        <h2 class="pb-4">"Nous sommes ceux que nous attendions."</h2>
                        <p>La Bascule est un mouvement citoyen qui n’attend que toi pour grandir.</br>Pour s’y investir, il suffit de partager sincèrement cette détermination à changer de cap.</p>
