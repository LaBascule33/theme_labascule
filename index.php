                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <ul>
                                            <li><span class="bf-under">Créer :</span>des lieux de bascule</li>
                                            <li><span class="bf-under">Faciliter:</span>l’engagement citoyen l’entraide entre porteurs de projets</li>
                                            <li><span class="bf-under">Amplifier:</span>la pression citoyenne les solutions existantes</li>
                                        </ul>
                                        <div class="pt-4 text-center">
                                        <a href="" class="btn btn-primary">En lire +</a>
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <ul>
                                            ...
                                            <li><span class="bf-under">Coopération & Evénements:</span> pour permettre aux acteurs qui le souhaitent de coopérer via un suivi au long cours, l’organisation d’ateliers de travail en intelligence collective, un soutien de communication, et de la mise en réseau.</li>
                                            <li><span class="bf-under">Lobbying Citoyen:</span> pour donner les moyens aux citoyens de comprendre, débattre et agir sur tous les sujets de Transition qui touchent notre société.</li>
