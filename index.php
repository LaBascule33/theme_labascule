...
<div class="container my-5">
    ...
    <nav>
        <div class="nav nav-tabs my-5" id="nav-tab" role="tablist">
            <a class="px-5 mx-2 nav-item nav-link active" id="nav-informe-tab" data-toggle="tab" href="#nav-informe" role="tab" aria-controls="nav-informe" aria-selected="true">
            ...
            <a class="px-5 mx-2 nav-item nav-link" id="nav-action-tab" data-toggle="tab" href="#nav-action" role="tab" aria-controls="nav-action" aria-selected="false">
            ...
            <a class="px-5 mx-2 nav-item nav-link" id="nav-rejoins-tab" data-toggle="tab" href="#nav-rejoins" role="tab" aria-controls="nav-rejoins" aria-selected="false">
            ...
            <a class="px-5 mx-2 nav-item nav-link" id="nav-soutien-tab" data-toggle="tab" href="#nav-soutien" role="tab" aria-controls="nav-soutien-tab" aria-selected="false">
            ...
            <a class="px-5 mx-2 nav-item nav-link" id="nav-suis-tab" data-toggle="tab" href="#nav-suis" role="tab" aria-controls="nav-suis" aria-selected="false">
            ...
            <a class="px-5 mx-2 nav-item nav-link" id="nav-contacte-tab" data-toggle="tab" href="#nav-contacte" role="tab" aria-controls="nav-contacte" aria-selected="false">
                ...
                <div class="row row-home-moi">
                    ...
                    <div class="col-4">
                        <ul class="list-style-custom">
                            <li><i class="arrow-right fas fa-arrow-right bc mr-2"></i>" Le rapport du GIEC décrypter "</li>
                            <li><i class="arrow-right fas fa-arrow-right bc mr-2"></i>" Effondrement : seul scénario réaliste ? "</li>
                            <li><i class="arrow-right fas fa-arrow-right bc mr-2"></i>" Le MOOC Energie & Climat "</li>
                            <li><i class="arrow-right fas fa-arrow-right bc mr-2"></i>" CO2 ou PIB il faut choisir "</li>
                        </ul>
                    </div>
                </div>
        </div>
