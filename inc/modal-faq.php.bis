        ...
        <div class="slide slide-active slide-1">
            <div class="container container-faq">
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="text-faq">
                            <h1 class="heading text-center bf pt-4 pb-4 js-title-faq">La <span class="text-uppercase">BASCULE,</span> <span class="bc">c'est quoi ?</span></h1>
        ...
        <div class="slide slide-2">
            <div class="container container-faq">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="text-faq">
                            <h1 class="heading text-center bf pt-4 pb-4 js-title-faq">La <span class="text-uppercase">BASCULE,</span> <span class="bc">c'est qui ?</span></h1>
        ...
        <div class="slide slide-3">
            <div class="container container-faq">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="text-faq">
                            <h1 class="heading text-center bf pt-4 pb-4 js-title-faq">La <span class="text-uppercase">BASCULE,</span> <span class="bc">pourquoi ?</span></h1>
        ...
        <div class="slide slide-4">
            <div class="container container-faq">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="text-faq">
                            <h1 class="heading text-center bf pt-4 pb-4 js-title-faq">La <span class="text-uppercase">BASCULE,</span> <span class="bc">pour quoi ?</span></h1>
        ...
        <div class="slide slide-5">
            <div class="container container-faq">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="text-faq">
                            <h1 class="heading text-center bf pt-4 pb-4 js-title-faq">La <span class="text-uppercase">BASCULE,</span> <span class="bc">comment faites-vous ?</span></h1>
        ...
        <div class="slide slide-6">
            <div class="container container-faq">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="text-faq">
                            <h1 class="heading text-center bf pt-4 pb-4 js-title-faq">La <span class="text-uppercase">BASCULE,</span> <span class="bc">oui mais concrètement ?</span></h1>
        ...
        <div class="slide slide-7">
            <div class="container container-faq">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="text-faq">
                            <h1 class="heading text-center bf pt-4 pb-4 js-title-faq">La <span class="text-uppercase">BASCULE,</span> <span class="bc">avec quels moyens ?</span></h1>
        ...
        <div class="slide slide-8">
            <div class="container container-faq">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="text-faq">
                            <h1 class="heading text-center bf pt-4 pb-4 js-title-faq">La <span class="text-uppercase">BASCULE,</span> <span class="bc">depuis quand ?</span></h1>
        ...
        <div class="slide slide-9">
            <div class="container container-faq">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="text-faq">
                            <h1 class="heading text-center bf pt-4 pb-4 js-title-faq">La <span class="text-uppercase">BASCULE,</span> <span class="bc">ça se passe ou ?</span></h1>
