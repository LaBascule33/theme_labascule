...
<!------------------------------------->
    <div class="row">
        ...
        <div class="col-6 block-text-right">
            <h3 class="text-uppercase">Une démarche personnelle<br>d'engagements</h3>
...
<!------------------------------------->
    <div class="row">
        <div class="col-6 block-text-left">
            <h3 class="text-uppercase">Une philosophie de coopération</h3>
...
<!------------------------------------->
    <div class="row">
        <div class="col-6 block-text-left">
            <h3><span class="text-uppercase">Des lieux</span> de bascule</h3>
            ...
            <ul>
                ...
                <li><span class="bf text-uppercase font-weight-bold">Apprendre</span> à vivre et faire ensemble</li>
                <li><span class="bf text-uppercase font-weight-bold">Grandir</span> son engagement</li>
            </ul>
        ...
        <div class="col-6 block-text-right">
            ...
            <div class="pt-4">
            <a href=""><i class="fas fa-download bc"></i> <span class="bf">Voir notre projet de développement</span></a>
            </div>
        </div>
    </div>
...
<!------------------------------------->
    <div class="container my-5">
        <h2 class="text-center text-uppercase my-5">Chiffres clés</h2>
        ...
        <div class="row">
            ...
            <div class="col-3 col-chiffres text-center">
                ...
                <h3 class="pt-4">000</h3>
                <p><span class="bf">Evénements animés</span> dans le cadre de</p>
